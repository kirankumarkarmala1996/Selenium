...
// by Using htmlUnitDriver it will not launch the browser with out launch browser it will execute the test cases.
...
//	This is the third way to execute the headless browser
	...
	public void headLessBrowser(ChromeDriver driver , WebElement element) {
		ChromeOptions chop = new ChromeOptions();
		chop.addArguments("headless");
		DesiredCapabilities dcp = new DesiredCapabilities();
